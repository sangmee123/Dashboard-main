...
>
>**상세 기능**
>- Map 페이지: Kakao 지도 API를 사용하여 현재 작업하고 있는 위치를 보이도록 합니다. 
>- Graph 페이지: Amchart 라이브러리를 사용하여 데이터를 시각화하였습니다.<br>오늘 작업을 시작한 시점에서부터 실시간으로 들어오는 데이터 값을 읽어 Line Graph로 보여줍니다.
